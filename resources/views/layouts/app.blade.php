    ...
    <div class="wrapper" >
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                <img src="{{asset('/imagens/logo.png')}}" width="60">
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    @if(Auth::user()->role > 1)
                                    <div class="pull-left">
                                        <a href="{{ url('admin/users/'.Auth::user()->id.'/edit') }}" class="btn btn-default btn-flat">
                                            Editar
                                        </a>                                        
                                    </div>
                                    @endif
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2020 <a href="www.yellowlamp.com.br">Yellow Lamp</a>.</strong> All rights reserved.
        </footer>
