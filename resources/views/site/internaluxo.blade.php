...
@include('flash::message')
    ...
    <div class="row InternasNovas dics">
        <div class="col-md-12 col-sm-12">
            @if($post->main_image != '')
            <div class="bxImagem" style="background-image:url({{$post->main_image}})">
                
            </div>
            @endif
             @if($post->secondary_image != '')
            <div class="bxImagem" style="background-image:url({{$post->secondary_image}})">
        ...
        <div class="col-sm-9 col-md-9">
            ...
            <form method="POST" action="{{route('commentpost')}}">
                ...
                <div class="row" style="margin-bottom:20px; margin-left:0px !important; margin-right:0px !important;">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="telefone" id="telefone" placeholder="Telefone" style="width:100%;"><br>
    ...
    <section class="container">
        <div class="carrosselDestaques dicas">
            <h2 style="padding-left:30px !important;">Veja Também</h2>
